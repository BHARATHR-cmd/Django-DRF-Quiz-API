...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='New Category', max_length=150, verbose_name='Quiz Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('techique', models.IntegerField(choices=[(0, 'Multiple Choice')], default=0, verbose_name='Type of the Question')),
                ('title', models.CharField(max_length=150, verbose_name='Title')),
                ('difficulty', models.IntegerField(choices=[(0, 'Fundamental'), (1, 'Beginner'), (2, 'Intermediate'), (3, 'Advanced'), (4, 'Expert')], default=0, verbose_name='Difficulty of the Question')),
